...
import com.fsck.k9.preferences.color_preference.ColorPickerSwatch.OnColorSelectedListener;
...
public class ColorPickerDialog extends DialogFragment implements OnColorSelectedListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.preference_color_picker_dialog, null);
